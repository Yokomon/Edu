    ...
    <div>   
      <div className="body main-header py-2">
        ...
        <div className="main-header Header">
              <div className="header-container position-relative" style={{padding: "150px 0",overflowX:"hidden"}}>
                  <div className="container">
      ...
      <main className="body py-5 container px-md-5">
         ...
         <div className="row">
            ...
            <div className="col-sm-6 col-md-4 mb-4 d-flex justify-content-center">
                <div className="upload-item rounded-sm">
                    <div className="upload-preview">
                        <img src="https://i.guim.co.uk/img/media/b29a436648610cd6e24d912c3cba7b6f3f1501cd/0_114_3500_2100/master/3500.jpg?width=620&quality=85&auto=format&fit=max&s=b562eee1a807ec4a71f93693e52ba496" className="img-fluid" alt=""/>
                    </div>
                    <div className="upload-body px-3 py-3">
                        <div className="d-flex  text-muted px-2 py-2">
         ...
         {/* Basically this is another section */}
         <section className="py-5">
            <div className="row align-items-center py-4">
                <div className="col-md-6 d-md-block" style={{display: "none"}}>
                    <img src="/images/group-3.svg" className="img-fluid" alt=""/>
                </div>
                <div className="col-md-6" style={{maxWidth: "400px"}}>
                    <h3 className="h4 mb-4 font-weight-bold">
                        Get the limitless learning with
                        more possibilities
                    </h3>
                    <p className="mb-4 text-muted small">You need to be sure there isn't anything embarrassing hidden
                        in the middle of text. All the Lorem Ipsum generators on the
                        Internet tend to repeat.</p>
                    <a href="/user/signup" className="btn btn-rounded px-4 btn-primary shadow-lg">TRY IT NOW</a>
                </div>
            </div>
        </section>

        {/* This is anothere section */}
        <section className="py-3">
            <div className="row align-items-center py-4">

                <div className="col-md-6 ml-auto" style={{maxWidth: "400px"}}>
                    <h3 className="h4 mb-4 font-weight-bold">
                        Get the limitless learning with
                        more possibilities
                    </h3>
                ...
                <div className="col-md-6 d-md-block" style={{display: "none"}}>
                    <img src="/images/group-4.svg" className="img-fluid" alt=""/>
                </div>
            </div>
        </section>
    </main>
